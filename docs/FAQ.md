...
If you have a local backend server running on localhost and need to connect it to the frontend, you can achieve it by following the below steps:
...
* Replace tools/srcServer.js with the following:
...
* Now you can call your local API as '/api/URL' where URL is the backend endpoint
