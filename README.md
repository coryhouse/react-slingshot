...
1. **Install [Node 4.0.0 or greater upto Node 6.x.x](https://nodejs.org)** - (5.0 or greater upto 6.x is recommended for optimal build performance). Node 7 isn't supported yet because it has removed the harmony_proxies flag in favor of harmony. `--harmony_proxies` is a necessary flag for Node 3 and Node 4. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm).
...
3. Install the latest version of Node below v7. Or install [Node 5.12.0](https://nodejs.org/download/release/v5.12.0/) if you're having issues on Windows. Node 6 has issues on some Windows machines.
