...
1. Make sure you ran all steps in the [initial machine setup](https://github.com/coryhouse/react-slingshot#initial-machine-setup) above, including the steps for your OS.
