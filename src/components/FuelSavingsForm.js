    ...
    <table>
      <tbody>
        <tr>
          ...
          <td><FuelSavingsTextInput id="newMpg" onChange={onChange} name="newMpg" value={fuelSavings.newMpg}/>
          </td>
        </tr>
        <tr>
          <td><label htmlFor="tradeMpg">Trade-in MPG</label></td>
          <td><FuelSavingsTextInput id="tradeMpg" onChange={onChange} name="tradeMpg" value={fuelSavings.tradeMpg}/>
          </td>
        </tr>
        <tr>
          <td><label htmlFor="newPpg">New Vehicle price per gallon</label></td>
          <td><FuelSavingsTextInput id="newPpg" onChange={onChange} name="newPpg" value={fuelSavings.newPpg}/>
          </td>
        </tr>
        <tr>
          <td><label htmlFor="tradePpg">Trade-in price per gallon</label></td>
          <td><FuelSavingsTextInput id="tradePpg" onChange={onChange} name="tradePpg" value={fuelSavings.tradePpg}/>
          </td>
        </tr>
        <tr>
