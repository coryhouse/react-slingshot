...
export default function fuelSavingsAppState(state = initialState, action) {
  switch (action.type) {
    case SAVE_FUEL_SAVINGS:
      ...
      // In a real app using Redux,
      // you might use redux-thunk and handle the async call in fuelSavingsActions.js
    ...
    case CALCULATE_FUEL_SAVINGS:
      {
        ...
        const newNecessaryDataIsProvided = calc.necessaryDataIsProvidedToCalculateSavings(newState);
        newState.necessaryDataIsProvidedToCalculateSavings = newNecessaryDataIsProvided;
