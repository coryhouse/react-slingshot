...
const fuelSavingsCalculator = () => {
  ...
  // public
  return {
    calculateMilesDrivenPerMonth: function _calculateMilesDrivenPerMonth(milesDriven,
    ...
    calculateSavingsPerMonth: function _calculateSavingsPerMonth(settings) {
      ...
      const tradeFuelCostPerMonth = calculateMonthlyCost(milesDrivenPerMonth,
        settings.tradePpg,
        settings.tradeMpg);
      const newFuelCostPerMonth = calculateMonthlyCost(milesDrivenPerMonth,
        settings.newPpg,
        settings.newMpg);
    ...
    calculateSavings: function _calculateSavings(settings) {
