...
fs.readFile('src/index.html', 'utf8', (err, markup) => {
  ...
  if (useTrackJs) {
    if (trackJsToken) {
      ...
      console.log('To track JavaScript errors, sign up for a free trial at TrackJS.com' +
        'and enter your token in /tools/build.html on line 10.'.yellow);
    }
  }

  fs.writeFile('dist/index.html', $.html(), 'utf8', (fileErr) => {
    if (fileErr) {
      console.log(fileErr);
      return;
    }
